import {
  type AirtableTypeString,
  type FromAirtableTypeString,
  type FromTsTypeString,
  type TsTypeString,
  parseType,
} from './typeUtils'
...
const coerce =
  <T extends TsTypeString>(airtableType: AirtableTypeString | 'unknown', tsType: T) =>
  (value: unknown): FromTsTypeString<T> => {
    ...
    if (
      parsedType.array &&
      Array.isArray(value) &&
      value.every((v) => typeof v === parsedType.single || (parsedType.arrayElementNullable && v === null))
    ) {
      return value as FromTsTypeString<T>
    }
...
const stringOrNull: Mapper = {
  'string | null': {
    ...
    multipleCollaborators: {
      ...
      fromAirtable: (value) =>
        coerce('multipleCollaborators', 'string | null')(multipleCollaboratorsMapperPair.fromAirtable(value)),
    },
    createdBy: {
    ...
    multipleAttachments: {
      toAirtable: readonly('multipleAttachments'),
      fromAirtable: (value) =>
        coerce('multipleAttachments', 'string | null')(multipleAttachmentsMapperPair.fromAirtable(value)),
    },
    multipleSelects: {
...
const numberNullableArrayOrNull: Mapper = {
  '(number | null)[] | null': {
    multipleLookupValues: {
      toAirtable() {
        throw new AirtableTsError({
      ...
      fromAirtable: coerce('multipleLookupValues', '(number | null)[] | null'),
    },
    unknown: {
      toAirtable: (value) => value,
      fromAirtable: coerce('unknown', '(number | null)[] | null'),
    },
  },
}
...
export const fieldMappers: Mapper = {
  ...
  string: {
    ...Object.fromEntries(
      Object.entries(stringOrNull['string | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            ...
            fromAirtable(value: null) {
              ...
              if (
                nullableValue === null &&
                ['multipleRecordLinks', 'dateTime', 'createdTime', 'lastModifiedTime'].includes(airtableType)
              ) {
                throw new AirtableTsError({
  ...
  boolean: {
    ...Object.fromEntries(
      Object.entries(booleanOrNull['boolean | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            toAirtable: nullablePair.toAirtable,
  ...
  number: {
    ...Object.fromEntries(
      Object.entries(numberOrNull['number | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            toAirtable: nullablePair.toAirtable,
  ...
  'string[]': {
    ...Object.fromEntries(
      Object.entries(stringArrayOrNull['string[] | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            toAirtable: nullablePair.toAirtable,
  ...
  '(string | null)[]': {
    ...Object.fromEntries(
      Object.entries(stringNullableArrayOrNull['(string | null)[] | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            toAirtable: nullablePair.toAirtable,
  ...
  '(boolean | null)[]': {
    ...Object.fromEntries(
      Object.entries(booleanNullableArrayOrNull['(boolean | null)[] | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            toAirtable: nullablePair.toAirtable,
  ...
  ...numberNullableArrayOrNull,
  '(number | null)[]': {
    ...Object.fromEntries(
      Object.entries(numberNullableArrayOrNull['(number | null)[] | null']!).map(([airtableType, nullablePair]) => {
        return [
          airtableType,
          {
            toAirtable: nullablePair.toAirtable,
